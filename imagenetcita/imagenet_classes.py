...
ImageNetEntry = namedtuple('ImagenetEntry', ['ID', 'index', 'description'])
...
labels_dict = {y[0]: ImageNetEntry(y[0], int(x), y[1]) for x, y in class_dict.items()}
"""
0 -> ('n01440764', ImagenetEntry(ID='n01440764', index=0, description='tench'))
1 -> ('n01443537', ImagenetEntry(ID='n01443537', index=1, description='goldfish'))
2 -> ('n01484850', ImagenetEntry(ID='n01484850', index=2, description='great_white_shark'))
3 -> ('n01491361', ImagenetEntry(ID='n01491361', index=3, description='tiger_shark'))
4 -> ('n01494475', ImagenetEntry(ID='n01494475', index=4, description='hammerhead'))
5 -> ('n01496331', ImagenetEntry(ID='n01496331', index=5, description='electric_ray'))
6 -> ('n01498041', ImagenetEntry(ID='n01498041', index=6, description='stingray'))
"""

id_to_class = {x: y[0] for x, y in class_dict.items()}
"""
0 -> ('0', 'n01440764')
1 -> ('1', 'n01443537')
2 -> ('2', 'n01484850')
...
id_to_name = {x: y[1] for x, y in class_dict.items()}
"""
0 -> ('0', 'tench')
1 -> ('1', 'goldfish')
...
if __name__ == "__main__":
    ...
    glimpse_dict(labels_dict)
    glimpse_dict(id_to_class)
    glimpse_dict(id_to_name)